...
func _enter_tree():
	...
	#add_custom_type( "SpineSkeletonResourceLoader", "ResourceFormatLoader", preload("SpineSkeletonResourceLoader.gd"), null )
...
func _exit_tree():
	...
	#remove_custom_type( "SpineSkeletonResourceLoader" )
